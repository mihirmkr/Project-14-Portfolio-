...
//         let drpDwn = document.getElementsByClassName("menu");
//         let i;
//         for (i = 0; i < drpDwn.length; i++) {
//             let openddMenu = drpDwn[i];
//             if (openddMenu.classList.contains('responsive')) {
//                 openddMenu.classList.remove('responsive');
//             }
//         }
//     }
// }
